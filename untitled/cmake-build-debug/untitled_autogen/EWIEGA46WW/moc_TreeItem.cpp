...
QT_MOC_LITERAL(1, 9, 13), // "onDataChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4) // "data"

    },
    "TreeItem\0onDataChanged\0\0data"
};
...
void TreeItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TreeItem::onDataChanged)) {
                *result = 0;
                return;
            }
        }
