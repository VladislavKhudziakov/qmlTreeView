...
QT_MOC_LITERAL(7, 50, 4) // "role"

    },
    "TestModel\0append\0\0value\0setData\0"
...
static const uint qt_meta_data_TestModel[] = {
 ...
 // methods: parameters
    ...
    QMetaType::Bool, 0x80000000 | 5, QMetaType::QVariant, QMetaType::Int,    6,    3,    7,
...
void TestModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->append((*reinterpret_cast< const QVariant(*)>(_a[1]))); break;
        case 1: { bool _r = _t->setData((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< const QVariant(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])));
